# Героёнок — прототип сайта

Прототип многостраничного сайта для генерации именных электронных книг для детей.

Стадия: дизайн-прототип (статичная вёрстка, без бэкенда и реальной генерации контента). Стили встроены в каждую страницу.
